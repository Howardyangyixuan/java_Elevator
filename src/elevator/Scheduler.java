...
public class Scheduler {
    ...
    public Scheduler() throws Throwable{
        this(10, 1);
    }
    //初始化调度器
    public Scheduler(int high, int low)throws Throwable {
        if(low != 1) {
            low = 1;
        }
        if(high < low) {
...
class ALS_Scheduler extends Scheduler {
    public ALS_Scheduler()throws Throwable {
        this(10, 1);
    }
    public ALS_Scheduler(int high, int low)throws Throwable {
        super(high, low);
    }
    public void runElevator()throws Throwable {
